<template>
  <div class="index">
    <div class="wrapper">
      ...
      <!-- 领取机会框 -->
      <div class="chance-box box-commen box box-tb box-center-center" v-if="false">
        <div class="img"></div>
      ...
      <!-- 登录框 -->
      <div class="login-box box-commen box box-tb box-center-center">
        <div class="login-info">
          <div class="phone-box login-commen">
            <input class="ml-24" type="text" placeholder="请输入领奖手机号码">
          </div>
