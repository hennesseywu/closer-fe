<template>
  <div class="activity">
    ...
    <Newuserpop ref="newuserpop" v-if="recieveChanceInfo.isPopUp" :newUser="recieveChanceInfo.status" :presentAvailable="recieveChanceInfo.presentAvailable" :isApp="isApp" :count="recieveChanceInfo.count"></Newuserpop>
